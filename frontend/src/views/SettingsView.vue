              ...
              <v-window-item value="general">
                <v-card-text>
                  ...
                  <v-row dense>
                    ...
                    <v-col cols="12"><v-switch label="使用代理" v-model="settingsStore.settings.enable_proxy" color="primary" inset hide-details /></v-col>
                    <v-col cols="12"><v-text-field label="代理地址" v-model="settingsStore.settings.proxy_url" variant="outlined" density="compact" :disabled="!settingsStore.settings.enable_proxy" hide-details /></v-col>
                  </v-row>
                </v-card-text>
              </v-window-item>
