      ...
      <v-col cols="12" md="10" lg="8" xl="6">
        ...
        <v-card v-else-if="settingsStore.settings">
          ...
          <v-tabs v-model="activeTab" bg-color="primary">
            ...
            <v-tab value="coin_pools">币种列表</v-tab>
          </v-tabs>
          <v-card-text>
        ...
        <v-skeleton-loader v-else type="card, article, actions"></v-skeleton-loader>
      </v-col>
    </v-row>
  </v-container>
</template>
...
import CoinPoolsDialog from '@/components/CoinPoolsDialog.vue';
import { ref } from 'vue';
